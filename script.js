...
const perfiles = {
  ...
  mireya: { nombre: 'Mireya Saraí García Vázquez', institucion: 'CITEDI-IPN', foto: 'assets/mireya-garcia-vazquez.jpg', contenido: '<p>Participante de CITEDI-IPN.</p>' },
  ...
  panel: { nombre: 'Panel: Colaboración académica: retos y oportunidades', institucion: '08:05–09:00 H · MODERA JORGE GARCÍA FLORES, MUFRAMEX', contenido: '<p>Participan Jenny Benois-Pineau, Mireya Saraí García Vázquez, Alán Rodrigo Díaz Rizo y José Cruz Núñez Pérez.</p>' }
};
